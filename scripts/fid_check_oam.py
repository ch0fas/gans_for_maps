...
# Config
REAL_DIR = "data/raw/styles_oam"
INPUT_DIR = "data/raw/trainB"
REAL_RESIZED = "data/processed/real_resized_oam"
FAKE_DIR = "data/tests/oam_results"
MODEL_PATH = "checkpoints/maps_test/latest_net_G_A.pth"
DEVICE = "cpu"
SIZE = 128
SAMPLE_SIZE = 20
SEED = 42
